...
from handlers import CitationUploadHandler, BibliographicEntityUploadHandler
from handlers import CitationQueryHandler, BibliographicEntityQueryHandler
from basic_full_qe import FullQueryEngine
...
class TestProjectBasic(unittest.TestCase):
    ...
    graph = "http://192.168.64.136:9999/blazegraph/"
